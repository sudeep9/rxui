...
func (p SelectProps) ClassName() string {
	classes := []string{"btn"}
	if p.Color != "" {
...
func Select(p SelectProps, attrs templ.Attributes) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `select.templ`, Line: 46, Col: 17}
		}
